...
library(gridExtra)
library(maps)
source("~/GitHub/Metastudy2/source_code/FIN_functions_meta_analysis.R")
...
load(file = "~/GitHub/Metastudy2/r_objects/shortdata.rda")
load(file = "~/GitHub/Metastudy2/r_objects/Grad_new.rda")
GradInfo <-  df # Gradient study
GradInfo$Response.variable[GradInfo$Response.variable == "OM (LOI)"] <- "TOC"

load(file = "~/GitHub/Metastudy2/r_objects/SummaryEF_Gradients_new.rda")
...
combined_plots
ggsave("~/GitHub/Metastudy2/final_review/figure1_info_world_season_stype_depth.png", units = "in", height = 10, width = 12)

```

#### Figure1Supplement: Justin edits

==\> Not fully implemented yet, Justin please edit.
...
stratplot <- ggplot(data = comz2, aes(x = Samplestyle)) + 
             ...
             facet_wrap(~ comz2$stype, ncol = 1)  # JT: Separate the plot into panels based on the 3rd column
...
ggsave("~/GitHub/Metastudy2/final_review/figure1SUPPLEMENT_info_strategy_stype_geartype.png", units = "in", height = 10, width = 12)
...
ggsave("~/GitHub/Metastudy2/final_review/figure1SUPPLEMENT_info_strategy_stype_geartype.png", units = "in", height = 6, width = 12)
...
ggsave("~/GitHub/Metastudy2/final_review/SUPPLEMENT_samples_per_variable_dfshort.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/final_review/SUPPLEMENT_samples_per_variable_expobs_morethan3studies.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/final_review/SUPPLEMENT_samples_per_variable_gradients.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/final_review/SUPPLEMENT_samples_per_variable_gradient_morethan3studies.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/final_review/SUPPLEMENT_variables_allstudytypes_morethan3studies.png", units = "in", height = 12, width = 9)
...
################## JT works with Summarizer but not Summarizer2 ###########
...
pdf("~/GitHub/Metastudy2/final_review/Figure2_trueresponseCORRECTED.pdf", height = 8, width = 10) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
...
# Making sure the variables will be displayed as desired
suball2   <- suball2[order(match(suball2$v, variables2)),]  # JT can't find relvar2, EDB: No longer needed.
...
pdf("~/GitHub/Metastudy2/final_review/Figure2SUPPLEMENT_expobs_separated_CORRECTED.pdf", height = 8, width = 10) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()

png("~/GitHub/Metastudy2/final_review/Figure2SUPPLEMENT_expobs_separated_CORRECTED.png", height = 8, width = 10, units = "in", res = 330) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
...
#ggsave("~/GitHub/Metastudy2/figures_final/Figure2_grad_trueresponse.png", units = "in", height = 2.5, width = 10)
pdf("~/GitHub/Metastudy2/final_review/Figure2_grad_trueresponseJT.pdf", height = 2.5, width = 10) #JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
...
ggsave("~/GitHub/Metastudy2/final_review/figure3_slicedepth_significantparmsandtn.pdf", units = "in", height = 10, width = 8)  
...
ggsave("~/GitHub/Metastudy2/final_review/figure3SUPPLEMENT_slicedepth_nonsig.pdf", units = "in", height = 5, width = 15)  
...
pdf("../figures_final/regplots.pdf", height = 3.5, width = 10) #JT
...
png("../figures_final/regplot_s5.png", height = 3.5, width = 10, units = "in", res = 330) #JT
...
png("../figures_final/regplot_s6.png", height = 11, width = 10, units = "in", res = 330) #JT
...
png("../figures_final/regplot_s7.png", height = 11, width = 10, units = "in", res = 330) #JT
...
ggsave("~/GitHub/Metastudy2/figures_final/Heatmap_coefficientsJT.png", units = "in", height = 13, width = 16)  
...
ggsave("~/GitHub/Metastudy2/figures_final/Heatmap_interceptsJT.png", units = "in", height = 13, width = 16)  
...
pdf("~/GitHub/Metastudy2/figures_final/Heatmaps2JT.pdf", height = 8, width = 10) #JT
