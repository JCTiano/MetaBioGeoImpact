...
variablesfull
ggsave("../figures/final_review/samples_per_variable_fulldata.png", units = "in", height = 5, width = 9)
...
ggsave("../figures/final_review/samples_per_variable_fulldata_morethan10.png", units = "in", height = 5, width = 9)
