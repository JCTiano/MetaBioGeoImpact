...
fulldfsel <- names(newdf)[c(8,9,15,35,36,37,20,2,1,14,18,19)]
...
studyplot <- ggplot(data = studytype2, aes(x = studytype2[,1])) + 
...
combined_plots
ggsave("~/GitHub/Metastudy2/figures_final/figure1_info_world_season_stype_depth.png", units = "in", height = 10, width = 12)
...
comz2 <- datall %>% distinct(datall$article_type_id, datall$samplestrat, datall$hstype) # JT modified
names(comz2) <- c("ArticleID", "Samplestyle", "stype") # JT modified
...
ggsave("~/GitHub/Metastudy2/figures_final/figure1SUPPLEMENT_info_strategy_stype_geartype.png", units = "in", height = 6, width = 12)
...
ggsave("~/GitHub/Metastudy2/figures_final/SUPPLEMENT_samples_per_variable_dfshort.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/figures_final/SUPPLEMENT_samples_per_variable_expobs_morethan3studies.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/figures_final/SUPPLEMENT_samples_per_variable_gradients.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/figures_final/SUPPLEMENT_samples_per_variable_gradient_morethan3studies.png", units = "in", height = 5, width = 9)
...
ggsave("~/GitHub/Metastudy2/figures_final/SUPPLEMENT_variables_allstudytypes_morethan3studies.png", units = "in", height = 12, width = 9)
...
# dfsummed <- summarizer2(dfshort) #JT
...
variables <- variables[c(2,6,7,1,4,3,14, 5,10,9,13,15,16,12,8,17,18,19,11)]
...
p <- ggplot(data = suball, aes(y = factor(v, levels = v))) +
  ...
  coord_cartesian(ylim=c(1,20), xlim=c(-1.1, 1.1)) +  
  theme_classic() +
...
pdf("~/GitHub/Metastudy2/figures_final/Figure2_trueresponseCORRECTED.pdf", height = 8, width = 10) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
...
# Making sure the variables will be displayed as desired
suball2   <- suball2[order(match(suball2$v, variables2)),]  # JT can't find relvar2
...
p <- ggplot(data = suball2, aes(y = rev(v), shape = stype)) +
  ...
  coord_cartesian(ylim=c(1,20), xlim=c(-1.9, 1.1)) +  
  theme_classic() +
...
# 
# subover2$ns <- factor(subover2$ns, levels = c(rev(subover2$ns)[1:36], "n Obs. (studies)"))
...
pdf("~/GitHub/Metastudy2/figures_final/Figure2SUPPLEMENT_expobs_separated_CORRECTED.pdf", height = 8, width = 10) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()

png("~/GitHub/Metastudy2/figures_final/Figure2SUPPLEMENT_expobs_separated_CORRECTED.png", height = 8, width = 10, units = "in", res = 330) # JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
```
...
pdf("~/GitHub/Metastudy2/figures_final/Figure2_grad_trueresponseJT.pdf", height = 2.5, width = 10) #JT
pleft + p + pright + plot_layout(design = layout)
dev.off()
